...
gen     skill_edu = 1 if educ_lev <= 5 &                  sample == 1 
replace skill_edu = 2 if educ_lev >= 5 & educ_level!=. &  sample == 1 
...
if $sector_model==3 {
	gen     sect_main3 = .
	replace sect_main3 = 1 if  industry3 == 1 & emplyd == 1 & skill_occup==0
	replace sect_main3 = 2 if  industry3 == 1 & emplyd == 1 & skill_occup==1
	replace sect_main3 = 3 if  industry3 == 2 & emplyd == 1 & skill_occup==0
	replace sect_main3 = 4 if  industry3 == 2 & emplyd == 1 & skill_occup==1
	replace sect_main3 = 5 if  industry3 == 3 & emplyd == 1 & skill_occup==0
	replace sect_main3 = 6 if  industry3 == 3 & emplyd == 1 & skill_occup==1
	label var sect_main3 "main economic sector" 

	* secondary activity
	gen     sect_secu3 = .
	replace sect_secu3 = 1 if  industry3_2 == 1 & emplyd == 1 & skill_occup==0
	replace sect_secu3 = 2 if  industry3_2 == 1 & emplyd == 1 & skill_occup==1
	replace sect_secu3 = 3 if  industry3_2 == 2 & emplyd == 1 & skill_occup==0
	replace sect_secu3 = 4 if  industry3_2 == 2 & emplyd == 1 & skill_occup==1
	replace sect_secu3 = 5 if  industry3_2 == 3 & emplyd == 1 & skill_occup==0
	replace sect_secu3 = 6 if  industry3_2 == 3 & emplyd == 1 & skill_occup==1
	label var sect_secu3  "secondary economic sector" 

	label def sectors         ///
	1 "Agriculture"   ///
	2 "Industry"   ///
	3 "Services", replace
	label values sect_main3 sect_secu3 sectors
}
...
replace occupation = 2 if  sect_main3 == 1
replace occupation = 3 if  sect_main3 == 2
replace occupation = 4 if  sect_main3 == 3
replace occupation = 5 if  sect_main3 == 4
replace occupation = 6 if  sect_main3 == 5
replace occupation = 7 if  sect_main3 == 6
...
local var "ln_lai_m sect_main3 industry3 occupation"
